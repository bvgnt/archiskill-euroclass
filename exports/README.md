...
Fichiers générés automatiquement depuis les tables CSV de la v0.11
(68 éléments EU-E, 141 ouvrages EU-O, 21 lots pivots EU-L, 7 ouvrages immatériels EU-W).
...
- **EU-O** : premier compo
sant décalé de **+50** pour éviter les collisions — `EU-O 10 10 01` → clé `60 10 1`. Le vrai code figure en tête de libellé.
...
## Convention de codification EU-O (v0.11)
